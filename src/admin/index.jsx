...
const Admin = () => {
  ...
  return (
    <>
      <div className=" w-[400px] rounded-[5px] ml-[600px] m-[100px] bg-[#F0F1F3] ">
        <form onSubmit={handleSubmit} className="flex flex-col" action="">
          <h1 className="text-center text-2xl font-bold my-[20px] ">Admin</h1>
          <input
            className=" ml-[50px] bg-white p-[8px] outline-none rounded-[5px] w-[300px] "
            type="text"
          ...
          <br />
          <textarea
            className=" ml-[50px] bg-white outline-none w-[300px] p-[8px]"
          ...
          <br />
          <input
            className=" ml-[50px] bg-white outline-none rounded-[5px] w-[300px] p-[8px]"
            type="file"
            name="image"
          />
          <br />
